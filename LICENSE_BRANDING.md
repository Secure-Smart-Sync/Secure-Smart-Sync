...
However, if you publicly redistribute, publish, rebrand, or release derivative versions of this project, you must remove or replace original branding that may create confusion regarding official ownership.

This includes the project name, logos, icons, embedded branding assets, and other visual identity elements.
